...
var AnalyzeSentiment = require('./js/Discovery');
...
app.post('/services/AnalyzeSentiment', bodyParser.json({type: 'json'}));
//route /services/AnalyzeTone requests to the AnalyzeTone module
app.post('/services/AnalyzeSentiment', AnalyzeSentiment);
